...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/joshua.villanueva" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/jshvb/" },
  { icon: Instagram, link: "https://www.instagram.com/jshvb" }
];
