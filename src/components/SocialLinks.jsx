...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/jshvb/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@jshvb",
    icon: Instagram,
    url: "https://www.instagram.com/jshvb",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@jshvb",
    icon: Youtube,
    url: "https://www.youtube.com/@jshvb",
    color: "#FF0000",
